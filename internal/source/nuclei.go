...
func NewNucleiSource(cfg config.SourceConfig, httpClient *crawler.HTTPClient, writer *storage.Writer) *NucleiSource {
	return &NucleiSource{
		config:     cfg,
...
func (s *NucleiSource) Name() string {
	return s.config.Name
}

func (s *NucleiSource) Download(ctx context.Context) (*crawler.DownloadResult, error) {
